...
class GetPatientsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'orderBy' => 'string|nullable|in:id,name,medic_record_number,created_at,updated_at',
    ...
    public function messages(): array
    {
        return [
            ...
            'orderBy.in' => 'Order by hanya boleh: id, name, medic_record_number, created_at, updated_at.',
