...
class UpdateAnamnesisRequest extends FormRequest
{
    ...
    {
        return [
            'patient_complaint' => 'sometimes|string|max:1000',
            'present_illness' => 'sometimes|string|max:1000',
            'past_illness' => 'sometimes|string|max:1000',
            'allergy_history' => 'sometimes|string|max:1000',
            'family_history' => 'sometimes|string|max:1000',
            'madication_history' => 'sometimes|string|max:1000',
            'physical_exam' => 'sometimes|string|max:1000',
            'note' => 'sometimes|string|max:1000',
            'anamnesisDetails' => 'sometimes|array',
